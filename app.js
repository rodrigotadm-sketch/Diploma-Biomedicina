...
const FALLBACK_DATA = {
  ...
  "rvdd": {
    ...
    "descricao": "A solicitação de impressão da Representação Visual do Diploma Digital (RVDD) passou a ser realizada diretamente pelo egresso por meio do SIGA – Portal do Egresso (Acesso Externo). Processo SEI nº 23075.054060/2026-11.",
    "taxa": "R$ 75,00",
    "codigoServico": "11845",
    ...
    "passos": [
      "Acesse https://sistemas.ufpr.br/ e selecione Acesso Externo – SIGA.",
      "Faça login utilizando o CPF e a senha anteriormente utilizada no Portal do Aluno.",
      "No menu, acesse Impressão Diploma e clique em Solicitar Impressão.",
      "Siga as orientações apresentadas no sistema para o pagamento da taxa de R$ 75,00 e anexe o comprovante de pagamento.",
      "Após o upload do comprovante, clique em Solicitar Impressão.",
      "Acompanhe no próprio sistema a disponibilidade da RVDD para retirada no Setor de Atendimento da PROGRAP."
    ],
    "retirada": {
    ...
    "botoes": [
      {
        "rotulo": "Acessar SIGA – Portal do Egresso",
